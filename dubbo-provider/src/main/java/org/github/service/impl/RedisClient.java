...
public class RedisClient {
    ...
    private void initialPool()
    {
        ...
        jedisPool = new JedisPool(config,"192.168.1.33",6379);
    }
    ...
    private void initialShardedPool()
    {
        ...
        shards.add(new JedisShardInfo("192.168.1.33", 6379, "master"));
...
/*        System.out.println("原先key302不存在时，新增key302："+shardedJedis.setnx("key302", "value302"));
    ...
    public String SetOperate() {
        ...
        long startTimeSpop=System.currentTimeMillis();
        String popValue = jedis.spop("sets").toString();
        long endTimeSpop=System.currentTimeMillis();
        long durationSpop=endTimeSpop-startTimeSpop;
        funcName=funcName+"spop,spop执行时间："+durationSpop+"</br>";
        ...
        jedis.smove(key, value5, destKey);
        long endTimeSmove=System.currentTimeMillis();
        long durationSmove=endTimeSmove-startTimeSmove;
        funcName=funcName+"smove,smove执行时间："+durationSmove+"</br>";

        long startTimeRandomMember=System.currentTimeMillis();
        jedis.srandmember(key);
        long endTimeRandomMember=System.currentTimeMillis();
        long durationRandomMember=endTimeRandomMember-startTimeRandomMember;
        funcName=funcName+"srandmember,srandmember执行时间："+durationRandomMember+"</br>";
    ...
    public String HashOperate() {
       ...
       shardedJedis.hget("hashs", "key004");
        ...
        //shardedJedis.hscan("hashs",String.valueOf(0),new ScanParams());
